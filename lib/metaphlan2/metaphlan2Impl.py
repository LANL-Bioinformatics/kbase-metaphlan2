...
class metaphlan2:
    ...
    GIT_COMMIT_HASH = "bcdc8ae18701d58941f25b2bde792e07f6f934b9"
    ...
    def run_metaphlan2(self, ctx, params):
        ...
        for reads_item_i, input_reads_library_ref in enumerate(readsSet_ref_list):
            ...
            output_list.append(self.exec_metaphlan2(ctx, params)[0])
    ...
    def exec_metaphlan2(self, ctx, params):
        """
        :param params: instance of mapping from String to unspecified object
        :returns: instance of type "ReportResults" -> structure: parameter
           "report_name" of String, parameter "report_ref" of String
        ...
        # cmd = ['metaphlan2.py', '--input_type', input_type, '--bowtie2db', '/data/metaphlan2/',
        #        fastq_files_string, report_file]
        # logging.info(f"cmd {' '.join(cmd)}")
        # p = subprocess.Popen(cmd, stdout=subprocess.PIPE,
        #                      stderr=subprocess.STDOUT)
        # logging.info(f'metaphlan2 {p.communicate()}')

        logging.info(os.listdir(output_dir))
        cmd = ['/kb/module/lib/metaphlan2/src/metaphlan2.sh', '-d', '/data/metaphlan2/', '-f', input_type, '-i',
        ...
        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method exec_metaphlan2 return value ' +
                             'output is not type dict as required.')
        # return the results
        return [output]
    def status(self, ctx):
